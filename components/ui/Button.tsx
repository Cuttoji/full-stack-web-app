...
const variantStyles = {
  ...
  secondary: 'bg-white/60 backdrop-blur-md text-gray-700 hover:bg-white/80 focus:ring-[#2D5BFF] border border-white/40',
  ...
  ghost: 'bg-transparent text-gray-700 hover:bg-white/40 hover:backdrop-blur-md focus:ring-[#2D5BFF]',
  outline: 'border-2 border-[#2D5BFF]/30 bg-white/40 backdrop-blur-md text-[#2D5BFF] hover:bg-[#2D5BFF] hover:text-white focus:ring-[#2D5BFF]',
};
